...
function Update () {
    ...
    transform.FindChild("Pointlight").gameObject.GetComponent(Light).enabled = switch_on;
    transform.FindChild("Spotlight").gameObject.GetComponent(Light).enabled  = switch_on;
